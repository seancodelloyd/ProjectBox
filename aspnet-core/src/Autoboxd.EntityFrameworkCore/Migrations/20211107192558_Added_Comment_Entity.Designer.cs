...
namespace Autoboxd.Migrations
{
    ...
    [Migration("20211107192558_Added_Comment_Entity")]
    partial class Added_Comment_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Autoboxd.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Autoboxd.Items.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Autoboxd.ListItems.ListItem", b =>
                {
            ...
            modelBuilder.Entity("Autoboxd.Lists.List", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Autoboxd.Ratings.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Autoboxd.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Autoboxd.ListItems.ListItem", b =>
                {
                    b.HasOne("Autoboxd.Items.Item", "Item")
                        .WithMany("ListItems")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Autoboxd.Lists.List", null)
                        .WithMany("ListItems")
            ...
            modelBuilder.Entity("Autoboxd.Ratings.Rating", b =>
                {
                    b.HasOne("Autoboxd.Items.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Autoboxd.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("Autoboxd.Ratings.Rating", "Rating")
                        .WithMany()
